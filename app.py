...
input_prompt = st.chat_input("message Medibot.....")
...
if input_prompt:
    ...
    with st.chat_message("bot",avatar="attorney.svg"):
        with st.spinner("Thinking..."):
            ...
            full_response = "⚠️ **_Note: This offers basic medical advice and is not a complete substitute for consulting a Doctor** \n\n\n"
